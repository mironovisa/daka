...
function index({price, name, description}:{price:number, name:string, description?:string}) {
  return (
      <View>
          <View>
              <View style={{flexDirection: "row", alignItems:"center", padding: 15, justifyContent: "space-between"}}>
                  <View style={{flexDirection: "row", alignItems: "center"}}>
                      <View><Text style={{ fontSize: 30, fontWeight: "bold" }}>{price}</Text></View>
                      <View><FontAwesome5 name="shekel-sign" size={24} color="black" /></View></View>
          ...
          <View style={{width: width, alignItems: "center", justifyContent: "center", padding: 10, }}><View
